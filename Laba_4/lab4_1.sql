...
SELECT SUM(CASE WHEN eurusd_date LIKE '2000.06.%' AND  eurusd_max=0.9626 THEN 1 ELSE 0 END) as eurusd_count, SUM(CASE WHEN eurgbp_date LIKE '1999.07.%' AND  eurgbp_max=0.6488 THEN 1 ELSE 0 END) as eurgbp_count FROM market.forex;
